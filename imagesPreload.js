...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//=======================================================================================
//ATTENTION! This code is not mine and was originally made by Patrick Kerr a professor at 
//Háskóli Íslands for the class Tölvuleikjaforritun(TÖL308G) autumn 2017. None of this 
//code was changed and it's only used to preload images for further use for the program.
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//=======================================================================================
...
Image.prototype.asyncLoad = function(src, asyncCallback) {
    ...
    //next line is only for error handling
